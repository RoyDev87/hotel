<?php
    ...
    if(!isset($_SESSION['usuario'])){
        echo'
            <script>
                alert("Señor usuario, debe iniciar sesión");
...
<body>
                ...
                <div class="col-md-12">
                    <div class="text-bg">
                        <div class="padding_lert">
                            <h1>BIENVENIDO A HOTEL VERANUM</h1>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <form action="php/reserva_be.php" method="POST" class="formulario__reseva">
                    <!-- <form class="form_book"> -->
                        <div class="row">
                            <div class="col-md-3">
                                <label class="date">CHECK IN</label>
                                <input class="book_n" type="date" name="desde">
                            </div>
                            <div class="col-md-3">
                                <label class="date">CHECK OUT</label>
                                <input class="book_n" type="date" name="hasta">
                            </div>
                            <div class="col-md-3">
                                <label class="date">PERSONAS</label>
                                <input class="book_n" placeholder="1" type="type" name="personas">
                            </div>
                            <div class="col-md-3">
                                <button class="book_btn">Reservar</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="choose_box">
                        <div class="titlepage">
                            <h2><span class="text_norlam" id="Alojamiento">Elija un alojamiento</span> <br>Perfecto</h2>
                        </div>
